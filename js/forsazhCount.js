...
fetch(
    ...
    .then(data => {
        ...
        let scoreAll = document.querySelectorAll(".summAllScoreMob");
        ...
        var forsazh = new CountUp("outMobForsazh", summ, {
            startVal: 4265000,
...
setTimeout(() => {
    ...
    const endTimerForsazh = 'Feb 29 2024, 20:00 GMT+0600';
    ...
    function setTime(id, timesup) {
        let timer = document.getElementById(id),
            days = document.querySelectorAll('.daysForsazh'),
            hours = document.querySelectorAll('.hoursForsazh'),
            minutes = document.querySelectorAll('.minutesForsazh'),
        ...
        function update() {
            ...
            if (nowdate <= Date.parse(endTimerForsazh)) {
                var nowdate = Date.now();
                days.forEach(e => {
    ...
    setTime('timerForsazh', endTimerForsazh);
}, 1000);